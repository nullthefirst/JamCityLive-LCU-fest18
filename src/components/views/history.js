...
export default class History extends Component {
  render() {
    return (
      <div>
        <h1>History</h1>
        <img className="pic" src={'https://res.cloudinary.com/poetrique/image/upload/v1538031523/clients/jamcitylive/FridayNightSpice.jpg'} title="FridayNightSpice" alt="FridayNightSpice" />
